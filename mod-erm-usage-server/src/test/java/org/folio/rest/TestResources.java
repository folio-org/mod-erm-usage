...
public enum TestResources {
  ...
  R51_SAMPLE_DR_OLD_REGISTRY_DOMAIN("fileupload/DR_sample_r51_old_registry_domain.json"),
  ...
  R51_SAMPLE_TR_TSV_OLD_REGISTRY_DOMAIN("fileupload/TR_sample_r51_old_registry_domain.tsv"),
