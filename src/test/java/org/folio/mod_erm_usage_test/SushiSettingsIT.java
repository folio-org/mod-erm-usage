  ...
  public void checkThatWeCanAddGetPutAndDeleteSushiSettings() {
    SushiSetting sushiSetting = given()
        .body("{\n"
            ...
            + "  \"label\": \"Nature Sushi\",\n"
            + "  \"vendor_id\": \"uuid-123456789\",\n"
            + "  \"platform_id\": \"uuid-123456789\",\n"
            + "  \"harvesting_active\": true,\n"
            + "  \"api_type\": \"Sushi Lite\",\n"
            + "  \"vendor_service_url\": \"http://example.com\",\n"
            + " \"report_release\": 4,\n"
            + "  \"requested_reports\": [\n"
            + "    \"JR1\"\n"
            + "  ],"
            + "  \"customer_id\": \"12345def\",\n"
            + "  \"requestor_id\": \"1234abcd\",\n"
            + "  \"api_key\": \"678iuoi\",\n"
            + "  \"requestor_name\": \"Karla Kolumna\",\n"
            + "  \"requestor_mail\": \"kolumna@ub.uni-leipzig.de\"\n"
            + "}")
    ...
    given()
        .body("{\n"
            ...
            + "  \"api_key\": \"678iuoi\",\n"
            + "  \"requestor_name\": \"Karla Kolumna\",\n"
            + "  \"requestor_mail\": \"CHANGED@ub.uni-leipzig.de\"\n"
            + "}")
        .header("X-Okapi-Tenant", TENANT)
        .header("content-type", APPLICATION_JSON)
